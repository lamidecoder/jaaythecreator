 ...
 * fix-nav-contrast.js
 *
 * Patches components/navigation.tsx so the nav uses dark text on pages
 * that start with a light background (currently /about), instead of
 * paper-colored text that was invisible against it before the header
 * picks up its solid backdrop on scroll.
 *
 * Run once from your project root:  node fix-nav-contrast.js
 */
...
console.log("Updated components/navigation.tsx — the nav now uses dark text on light-background pages until it scrolls.");
