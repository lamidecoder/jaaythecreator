 ...
 * fix-hero-full-bg.js
 *
 * Reverts to a straightforward full-bleed video background, filling
 * the entire hero edge to edge (object-cover), with the split-panel
 * layout from the previous fix removed. Text sits over the video
 * again, so its shadow for legibility is back too.
 *
 * Run once from your project root:  node fix-hero-full-bg.js
 */
...
console.log("Updated components/hero.tsx — hero video is full background again, edge to edge.");
