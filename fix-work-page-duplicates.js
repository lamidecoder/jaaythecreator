...
/** Excluded here because each shares its video with a numbered piece
 * that also shows in this grid (emerald-and-gold uses piece-13's
 * clip, rose-and-marble uses piece-16's, the-ivory-hour uses
 * piece-14's) — showing both would be a duplicate. If you rename
 * another entry's hero to reuse a piece's video, add its slug here
 * too. */
const EXCLUDED_FROM_WORK = ["emerald-and-gold", "rose-and-marble", "the-ivory-hour"];
